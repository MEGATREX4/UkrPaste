    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center max-w-xl mx-auto w-full">
        ...
        <div className="flex gap-4">
          <a href="index" className="bg-gray-300 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-black dark:text-white px-6 py-3 rounded-md flex items-center gap-2 justify-center">
        ...
        <div className="grid grid-cols-1 pb-6 sm:grid-cols-2 gap-3 max-w-6xl mx-auto">
          <a href="https://savelife.in.ua" className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4 flex flex-col items-center justify-between transition duration-300 hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <a href="https://prytulafoundation.org/" className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4 flex flex-col items-center justify-between transition duration-300 hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <a href="https://www.sternenkofund.org/" className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4 flex flex-col items-center justify-between transition duration-300 hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700">
          ...
          <a href="https://united24.gov.ua" className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4 flex flex-col items-center justify-between transition duration-300 hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-700">
